public class SinglyLinkedListIntSortedInsert1Bug {
    ...
    public /*@nullable@*/ SinglyLinkedListNodeInt header;
    ...
    @*/
    public void sortedInsert(/*@nullable@*/ SinglyLinkedListNodeInt newNode) {
    	SinglyLinkedListNodeInt currentRef = this.header;
    	SinglyLinkedListNodeInt prevRef = null;
