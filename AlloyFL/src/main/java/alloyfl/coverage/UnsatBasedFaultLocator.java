...
public class UnsatBasedFaultLocator {
  ...
  public static void localize(FaultLocatorOpt opt) {
    ...
    for (Node node : reportedNodes) {
      System.out.println(node.accept(opt.getPSV(), null));
    }
    Codec.serialize(
...
//    args = new String[]{"experiments/realbugs/farmerFaulty.als",
//        "experiments/test-suite/alloyfl.mutation-based/100/farmer.als", ""};
    String modelPath = "experiments/gen/real/arr1/arr1.als";
    String testPath = "experiments/test-suite/mutation-based/100/arr.als";
